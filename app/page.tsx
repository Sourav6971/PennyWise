...
export default function Home() {
  return (
    <div className="flex flex-col md:flex-row min-h-screen overflow-x-hidden bg-gradient-to-br from-white to-gray-50">
      <CategoryBar />

      <div className="flex flex-1 flex-col p-4 md:p-6 lg:p-8 space-y-8">
